...
int osal_wait_init(osal_wait_t *wait)
{
	...
	wq = (wait_queue_head_t *)kmalloc(sizeof(wait_queue_head_t),
					  GFP_ATOMIC);
	if (wq == NULL) {
...
int osal_wait_interruptible(osal_wait_t *wait, osal_wait_cond_func_t func,
			    void *param)
{
	wait_queue_head_t *wq = NULL;
	DEFINE_WAIT(__wait);
...
int osal_wait_uninterruptible(osal_wait_t *wait, osal_wait_cond_func_t func,
			      void *param)
{
	wait_queue_head_t *wq = NULL;
	DEFINE_WAIT(__wait);
...
int osal_wait_timeout_interruptible(osal_wait_t *wait,
...
int osal_wait_timeout_uninterruptible(osal_wait_t *wait,
				      osal_wait_cond_func_t func, void *param,
				      unsigned long ms)
{
	wait_queue_head_t *wq = NULL;
